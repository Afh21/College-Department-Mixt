<div id="modalEditPeriod" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="row">
            <form class="col l8 push-l2" id="formUpdate">
                <input type="hidden" id="tokenEdit" name="_token" value="{{csrf_token()}}">
                <div class="row">
                    <div class="input-field">
                        <i class="fa fa-angle-right prefix"></i>
                        <input id="name" type="text" class="validate" name="update">
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-footer" style="margin: 0px ">
        ...
        <ul style="list-style-type: none">
            <li style="display: inline-block">
                <button class="waves-effect waves-green white btn-floating center updatePeriod">
